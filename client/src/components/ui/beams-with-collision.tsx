...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    ...
    >
      ...
      <div
        ref={containerRef}
        className="absolute bottom-0 bg-orange-100 w-full inset-x-0 pointer-events-none"
        style={{
          boxShadow:
  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-gradient-to-t from-orange-500 via-porangeurple-700 to-transparent",
    ...
    <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
      ...
      {spans.map((span) => (
        <motion.span
          ...
          className="absolute h-1 w-1 rounded-full bg-gradient-to-b from-orange-500 to-orange-800"
        />
      ))}
    </div>
  );
